        ...
        <div style={{
          ...
          <div className="glass-panel" style={{ width: '100%', maxWidth: '440px', padding: '28px', borderRadius: '16px' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px', color: '#f87171', marginBottom: '16px' }}>
              ...
              <h3 style={{ fontSize: '1.2rem', fontWeight: '700', margin: 0 }}>Delete User Account</h3>
            </div>
            ...
            <div style={{ display: 'flex', justifyContent: 'flex-end', gap: '12px' }}>
              ...
              <button
                ...
                style={{ background: '#ef4444', color: '#fff', padding: '8px 18px', borderRadius: '8px', border: 'none', fontWeight: '600', cursor: 'pointer' }}
                disabled={deleting}
              >
      ...
      <div style={{
        ...
        <button
          ...
          style={{
            ...
            boxShadow: activeTab === 'users' ? '0 4px 14px rgba(99, 102, 241, 0.35)' : 'none',
        ...
        >
          ...
          <span style={{
            background: activeTab === 'users' ? 'rgba(255, 255, 255, 0.25)' : 'rgba(255, 255, 255, 0.1)',
            padding: '2px 8px',
            borderRadius: '12px',
            fontSize: '0.78rem',
            fontWeight: '700',
        ...
        <button
          ...
          style={{
            ...
            fontWeight: '600',
            fontSize: '0.95rem',
            background: activeTab === 'classes' ? 'var(--primary)' : 'rgba(255, 255, 255, 0.05)',
            color: activeTab === 'classes' ? '#ffffff' : 'var(--text-muted)',
            boxShadow: activeTab === 'classes' ? '0 4px 14px rgba(99, 102, 241, 0.35)' : 'none',
            transition: 'all 0.2s ease',
          }}
        >
          <School size={18} />
          ...
          <span style={{
            background: activeTab === 'classes' ? 'rgba(255, 255, 255, 0.25)' : 'rgba(255, 255, 255, 0.1)',
            padding: '2px 8px',
            borderRadius: '12px',
            fontSize: '0.78rem',
            fontWeight: '700',
        ...
        <button
          ...
          style={{
            ...
            fontWeight: '600',
            fontSize: '0.95rem',
            background: activeTab === 'submissions' ? 'var(--primary)' : 'rgba(255, 255, 255, 0.05)',
            color: activeTab === 'submissions' ? '#ffffff' : 'var(--text-muted)',
            boxShadow: activeTab === 'submissions' ? '0 4px 14px rgba(99, 102, 241, 0.35)' : 'none',
            transition: 'all 0.2s ease',
          }}
        >
          <FileText size={18} />
          ...
          <span style={{
            background: activeTab === 'submissions' ? 'rgba(255, 255, 255, 0.25)' : 'rgba(255, 255, 255, 0.1)',
            padding: '2px 8px',
            borderRadius: '12px',
            fontSize: '0.78rem',
            fontWeight: '700',
      ...
      {activeTab === 'users' && (
        <div>
          ...
          <div style={{ display: 'flex', flexWrap: 'wrap', alignItems: 'center', justifyContent: 'space-between', gap: '16px', marginBottom: '20px' }}>
            ...
            {/* Role Filter Pills */}
            <div style={{ display: 'flex', alignItems: 'center', gap: '8px', background: 'rgba(255,255,255,0.04)', padding: '4px', borderRadius: '10px', border: '1px solid var(--border-subtle)' }}>
              {['all', 'student', 'admin'].map((r) => (
                <button
                  ...
                  style={{
                    ...
                    color: userRoleFilter === r ? '#fff' : 'var(--text-muted)',
                  ...
                  {loading ? (
                    <tr>
                      <td colSpan={8} style={{ textAlign: 'center', padding: '48px', color: 'var(--text-muted)' }}>
                        <div className="animate-spin" style={{ width: '28px', height: '28px', border: '3px solid var(--border-subtle)', borderTopColor: 'var(--accent-cyan)', borderRadius: '50%', margin: '0 auto 12px' }} />
                    ...
                    users.map((u) => (
                      ...
                      >
                        <td style={{ padding: '14px 18px', fontFamily: 'var(--font-mono)', color: 'var(--accent-cyan)', fontWeight: '600' }}>
                          #{u.id}
                        </td>
                        <td style={{ padding: '14px 18px' }}>
                          <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                            <div style={{
                              ...
                              height: '32px',
                              borderRadius: '50%',
                              background: u.role === 'admin' ? 'linear-gradient(135deg, #ef4444, #f97316)' : 'linear-gradient(135deg, #6366f1, #06b6d4)',
                              color: '#fff',
                              display: 'flex',
                              alignItems: 'center',
                              justifyContent: 'center',
                        ...
                        <td style={{ padding: '14px 18px', fontFamily: 'var(--font-mono)', color: '#e5e7eb', fontSize: '0.85rem' }}>
                          {u.student_id_str || u.id}
                        </td>
                        <td style={{ padding: '14px 18px' }}>
                          {u.role === 'admin' ? (
                            <span className="badge badge-graded" style={{ padding: '3px 8px', fontSize: '0.75rem', fontWeight: '700' }}>
                              Admin
                            </span>
                          ) : u.teaching_classes_count > 0 ? (
                            <span className="badge" style={{ background: 'rgba(168, 85, 247, 0.2)', color: '#c084fc', border: '1px solid rgba(168, 85, 247, 0.35)', padding: '3px 8px', fontSize: '0.75rem', fontWeight: '700' }}>
                              Instructor
                            </span>
                          ) : (
                            <span className="badge badge-pending" style={{ padding: '3px 8px', fontSize: '0.75rem', fontWeight: '700' }}>
                              Student
                            </span>
                          )}
                        </td>
                        <td style={{ padding: '14px 18px', color: 'var(--text-muted)', fontSize: '0.82rem' }}>
                          {u.teaching_classes_count > 0 ? (
                            <span>Teaches: <strong>{u.teaching_classes_count}</strong></span>
                          ) : (
                            <span>Enrolled: <strong>{u.enrolled_classes_count}</strong></span>
                          )}
                        </td>
                        ...
                        <td style={{ padding: '14px 18px', textAlign: 'right' }}>
                          {u.id !== currentUser?.id ? (
                            <button
                              ...
                              className="btn-ghost"
                              style={{ color: '#f87171', padding: '6px 10px', borderRadius: '6px' }}
                              title="Delete user"
                            >
                              <Trash2 size={16} />
                            </button>
                  ...
                  {filteredClasses.length === 0 ? (
                    ...
                    filteredClasses.map((c) => (
                      ...
                      >
                        ...
                        <td style={{ padding: '14px 18px' }}>
                          <span style={{ background: 'rgba(99, 102, 241, 0.15)', border: '1px solid rgba(99, 102, 241, 0.3)', padding: '3px 8px', borderRadius: '6px', fontFamily: 'var(--font-mono)', fontWeight: '700', color: 'var(--accent-cyan)' }}>
                            {c.code}
                          </span>
                        </td>
                        <td style={{ padding: '14px 18px' }}>
                          <div style={{ fontWeight: '600', color: '#fff' }}>{c.teacher_name}</div>
                  ...
                  {filteredSubmissions.length === 0 ? (
                    ...
                    filteredSubmissions.map((s) => (
                      ...
                      >
                        ...
                        <td style={{ padding: '14px 18px' }}>
                          <div style={{ fontWeight: '600', color: '#fff' }}>{s.assignment_title}</div>
                          <div style={{ fontSize: '0.75rem', color: 'var(--accent-cyan)' }}>{s.class_name}</div>
                        </td>
                        ...
                        <td style={{ padding: '14px 18px', fontWeight: '700' }}>
                          {s.marks !== null ? (
                            <span style={{ color: '#34d399' }}>{s.marks} / {s.max_marks}</span>
                          ) : (
