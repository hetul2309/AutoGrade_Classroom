      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
            ...
            <span style={{ fontWeight: '700', fontSize: '1.1rem', color: 'var(--text-main)' }}>Confirm Sign Out</span>
          </div>
          <button
            onClick={onClose}
            style={{
        ...
        <div style={{ padding: '24px' }}>
          ...
          <div style={{
            ...
            <button
              ...
              style={{ padding: '10px 18px', borderRadius: '10px', fontSize: '0.9rem', cursor: 'pointer' }}
            >
              Cancel
            </button>
            <button
