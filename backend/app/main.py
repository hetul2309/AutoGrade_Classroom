            ...
            if student.id in sub_map:
                ...
                items.append(
                    AdminGradeItem(
                        ...
                        student_id_str=sub.student.student_id_str if (sub.student and sub.student.student_id_str) else (student.student_id_str if student else None),
        ...
        if sub.student_id not in processed_student_ids:
            ...
            items.append(
                AdminGradeItem(
                    ...
                    submission_id=sub.id,
                    student_id=sub.student_id,
                    student_id_str=sub.student.student_id_str if sub.student else None,
...
async def edit_grade_manually(
    ...
    return AdminGradeItem(
        ...
        submission_id=sub.id,
        student_id=sub.student_id,
        student_id_str=student.student_id_str if student else None,
